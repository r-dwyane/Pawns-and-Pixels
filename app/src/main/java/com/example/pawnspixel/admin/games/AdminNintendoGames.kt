...
class AdminNintendoGames : Fragment() {
    ...
    private lateinit var admin_nintendoGamesRecyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        admin_nintendoGamesRecyclerView = view.findViewById(R.id.admin_nintendoGamesRecyclerView)
    ...
    private fun setupRecyclerView() {
        admin_nintendoGamesRecyclerView.layoutManager = LinearLayoutManager(requireContext())
        ...
        admin_nintendoGamesRecyclerView.adapter = boardGamesAdapter
    }
