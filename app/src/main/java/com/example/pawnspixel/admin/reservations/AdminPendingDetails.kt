...
class AdminPendingDetails : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_pending_details, container, false)

        val roomText: TextView = view.findViewById(R.id.admin_pending_details_room)
        val dateText: TextView = view.findViewById(R.id.admin_pending_details_date)
        val startTimeText: TextView = view.findViewById(R.id.admin_pending_details_start_time)
        val endTimeText: TextView = view.findViewById(R.id.admin_pending_details_end_time)
        val reservationIdText: TextView = view.findViewById(R.id.admin_pending_details_reservation_id)
        val playersText: TextView = view.findViewById(R.id.admin_pending_details_players)
        val createdAtText: TextView = view.findViewById(R.id.admin_pending_details_created_at)
        val emailText: TextView = view.findViewById(R.id.admin_pending_details_email)
        val nameText: TextView = view.findViewById(R.id.admin_pending_details_name)
        val back: ImageView = view.findViewById(R.id.admin_backHome82)
        val accepted: Button = view.findViewById(R.id.acceptReservation)
        val declined: Button = view.findViewById(R.id.declineReservation)
                ...
                accepted.setOnClickListener {
                    db.collection("bookings").document(reservationId)
                        ...
                        .addOnSuccessListener {
                            Toast.makeText(requireContext(), "Reservation Accepted", Toast.LENGTH_SHORT).show()
        ...
        declined.setOnClickListener {
            ...
            val cancelPopup = AdminDeclinePopup()
            val args = Bundle()
            args.putString("reservationId", reservationId)
            cancelPopup.arguments = args

            cancelPopup.show(parentFragmentManager, "AdminDeclinePopup")
        }
