...
class AdminBilliardTable : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_billiard_table, container, false)
        ...
        descriptionEditText = view.findViewById(R.id.adminBilliardRoomsEquipmentsDesc)
        statusSpinner = view.findViewById(R.id.adminBilliardRoomsEquipmentsStatus)
        updateButton = view.findViewById(R.id.admin_billiardUpdate)
    ...
    private fun updateRoomStatus(newDescription: String, newStatus: String) {
        ...
        db.collection("rooms")
            .whereEqualTo("room_name", "billiard")
            .get()
            .addOnSuccessListener { documents ->
                if (!documents.isEmpty) {
