...
class AdminPrivateRoom : Fragment() {
    ...
    private val roomName = "private_room"
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_private_room, container, false)
        ...
        descriptionEditText = view.findViewById(R.id.adminPrivateRoomsEquipmentsDesc)
        statusSpinner = view.findViewById(R.id.adminPrivateRoomsEquipmentsStatus)
    ...
    private fun updateRoomStatus(newDescription: String, newStatus: String) {
        ...
        db.collection("rooms")
            .whereEqualTo("room_name", "private_room")
            .get()
            .addOnSuccessListener { documents ->
                if (!documents.isEmpty) {
