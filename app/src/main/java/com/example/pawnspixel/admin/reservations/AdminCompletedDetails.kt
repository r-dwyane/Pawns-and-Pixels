...
class AdminCompletedDetails : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_completed, container, false)
        val roomText: TextView = view.findViewById(R.id.admin_completed_details_room)
        val dateText: TextView = view.findViewById(R.id.admin_completed_details_date)
        val startTimeText: TextView = view.findViewById(R.id.admin_completed_details_start_time)
        val endTimeText: TextView = view.findViewById(R.id.admin_completed_details_end_time)
        val reservationIdText: TextView = view.findViewById(R.id.admin_completed_details_reservation_id)
        val playersText: TextView = view.findViewById(R.id.admin_completed_details_players)
        val createdAtText: TextView = view.findViewById(R.id.admin_completed_details_created_at)
        val emailText: TextView = view.findViewById(R.id.admin_completed_details_email)
        val nameText: TextView = view.findViewById(R.id.admin_completed_details_name)
