    ...
    override fun onCreateView(
        ...
        adapter = AdminReservationAdapter(filteredList, object : AdminReservationAdapter.OnItemClickListener {
            override fun onItemClick(position: Int) {
                ...
                val detailsFragment = AdminCancelledDetails()
            ...
            .addSnapshotListener { snapshots, error ->
                ...
                if (snapshots != null && !snapshots.isEmpty) {
                    ...
                    for (document in snapshots) {
                        ...
                        // If userId exists, store it for lookup
                        if (!reservation.userId.isNullOrEmpty()) {
                            userIds.add(reservation.userId!!)
                        } else {
                            // If userId is missing, use the customerName from the booking itself
                            reservation.customerName = document.getString("customerName") ?: "Unknown"
                        }
